...
- **Attribution & Transparenz**: Siehe [`NOTICE`](NOTICE) und [`THIRD_PARTY_LICENSES.md`](THIRD_PARTY_LICENSES.md) für rechtliche Hinweise, Urheberschaft und vollständige Open-Source-Abhängigkeitsaudits.
